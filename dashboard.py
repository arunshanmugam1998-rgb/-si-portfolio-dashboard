...
def load_ticker_map():
    """
    Build ticker map from SI_Portfolio (col A = company name as in All Trades,
    col B = NSE ticker). Exact match guaranteed — no name normalisation needed.
    Appends '.NS' to convert to yfinance format.
